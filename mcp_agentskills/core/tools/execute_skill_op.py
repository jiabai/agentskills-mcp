        ...
        try:
            ...
            async for session in get_async_session():
                ...
                if not skill_md_path.exists():
                    self.set_output(tool_error_payload("SKILL.md not found", "SKILL_MD_NOT_FOUND"))
                    return
                ...
                if not command or not isinstance(command, str):
                    self.set_output(tool_error_payload("Skill entrypoint not configured", "SKILL_EXECUTION_NOT_CONFIGURED"))
                    return
